...
export class FilterablePersonList extends React.Component<FilterablePersonListProps, ThisState> {
    ...
    private renderColumns(items: PersonGroup[]) {
        ...
        //TODO: Do column splitting using CSS3 column-count property (see gallery.scss)
        return (
            <div className="row">
    ...
    private arrangeAndFilter(rawData: IPerson[], filterText: string) {
    ...
    private arrangeGroups(rawData: IPerson[]): PersonGroup[] {
